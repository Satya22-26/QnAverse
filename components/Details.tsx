...
const Details: React.FC<{ question: QuestionProp | null }> = ({ question }) => {
  ...
  return (
    <>
      <div className="flex flex-col mt-10 space-y-5 text-[#fef4f4]">
        <div className="flex justify-between items-center">
          <h4
            className="inline-block from-amber-700 to-yellow-400 leading-[30px]
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-wrap text-[14px]">
            <div className="hidden sm:flex justify-center items-center space-x-2  mr-3">
              <BsCalendar3 size={20} className='text-yellow-400'/>
              <span>
                Asked <Moment fromNow>{question.created}</Moment>
              </span>
            </div>
      ...
      <div className="flex flex-col space-y-3 sm:hidden mt-5 text-[#fef6f6]">
