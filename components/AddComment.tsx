...
const AddComment: React.FC<{ questionData: QuestionProp | null }> = ({ questionData }) => {
  ...
  return (
    ...
    >
      <div className="bg-[#252525] text-[#faf4f4] shadow-lg shadow-yellow-400 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          >
            <textarea
              className="h-[25vh] w-full bg-transparent border border-amber-700 rounded-xl py-3 px-3 text-white placeholder-yellow-400
            ...
            right-2 sm:right-10 hover:bg-amber-700 transition-colors duration-300 mt-5"
            >
              Submit
            </button>
          </form>
