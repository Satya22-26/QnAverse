...
const UpdateQuestion: React.FC<{ questionData: QuestionProp | null }> = ({ questionData }) => {
  ...
  return (
    ...
    >
      <div className="bg-[#252525] text-[#fbf5f5] shadow-lg shadow-yellow-400 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          >
            ...
            <textarea
              ...
              className="mt-2 h-[162px] w-full bg-transparent border border-amber-700 rounded-xl py-3 px-3
