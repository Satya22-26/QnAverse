...
const DeleteQuestion: React.FC<{ questionData: QuestionProp | null }> = ({ questionData }) => {
  ...
  return (
    ...
    >
      <div className="bg-[#252525] text-[#fff] shadow-lg shadow-lime-400 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          <div className="flex justify-center items-center space-x-2">
            <button
              className="text-sm border border-lime-500 rounded-full w-[150px] h-[48px] text-white
            ...
            <button
              className="text-sm border border-red-700 bg-red-600 rounded-full w-[150px] h-[48px] text-white
